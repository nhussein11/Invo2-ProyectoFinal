...
def neighbours(arr,_row,_column):
    if _row+_column==0:
        ...
        a = [arr[0][[_column-1,_column+1]],arr[1][[_column,_column+1,_column-1]]]
        return a
    elif _row==0 and _column==column-1:
        ...
        a = [arr[_row][[_column-1,_column+1]],arr[_row-1][[_column,_column+1,_column-1]]]
        return a
    elif _row==row-1 and _column==column-1:
        a = [arr[_row][_column-1],arr[_row-1][[_column-1,_column]]]
        return a
    elif _column==0:
        a = [arr[_row-1][[_column,_column+1]],arr[_row][_column+1],arr[_row+1][[_column,_column+1]]]
        return a
    elif _column==column-1:
        a = [arr[_row-1][[_column,_column-1]],arr[_row][_column-1],arr[_row+1][[_column,_column-1]]]
        return a
    else:
        a = [arr[_row-1][[_column-1,_column,_column+1]],arr[_row][[_column-1,_column+1]],arr[_row+1][[_column-1,_column,_column+1]]]
        return a
